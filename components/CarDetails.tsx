                ...
                <Dialog as='div' className={"relative z-10"} onClose={closeModal}>
                    ...
                    <div className='fixed inset-0 overflow-y-auto'>
                        <div className='flex min-h-full items-center justify-center p-4 text-center'>
                            ...
                            >
                                <Dialog.Panel className={"relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all p-6 flex flex-col gap-5"}>
                                    <button type="button" onClick={closeModal} className='w-fit p-2 bg-primary-blue-100 rounded-full absolute top-2 right-2 z-10'>
                                        <Image src={"/close.svg"} alt='close' width={20} height={20} className='object-contain' />
                                    </button>

                                    <div className="flex-1 flex flex-col gap-3">
                                        <div className="relative w-full h-40 bg-gradient-to-r from-cyan-500 to-blue-500 bg-cover bg-center rounded-lg">
